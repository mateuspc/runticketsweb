...
class TextInputCidade extends StatefulWidget {
  ...
  @override
  State<TextInputCidade> createState() => _TextInputState();
}

class _TextInputState extends State<TextInputCidade> {
