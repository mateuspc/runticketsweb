...
class TextInputBairro extends StatefulWidget {
  ...
  @override
  State<TextInputBairro> createState() => _TextInputState();
}

class _TextInputState extends State<TextInputBairro> {
              ...
              child: Focus(
                ...
                child: ClipRRect(
                  ...
                  child: TextField(
                    ...
                    onChanged: (value) {
                      widget.cubit.validateNomeBairro(value);
                    },
                  ),
                ),
              ),
